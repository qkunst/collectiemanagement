...
module Artist::NameRenderer
  ...
  included do
    def name(options={})
      ...
      return (rname == "" and options[:render_error]) ? "-geen naam opgevoerd (#{id})-" : rname
    end
    ...
    def to_json_for_simple_artist return_pre_json=false
      ...
      return return_pre_json ? obj : obj.to_json
    end
  end

  class_methods do
    def to_json_for_simple_artist
      self.all.map{|a| a.to_json_for_simple_artist(true)}.to_json
    end
  end
end
