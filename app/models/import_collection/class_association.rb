...
class ImportCollection::ClassAssociation
  ...
  def importable?
    unless ["PaperTrail::Version", "Currency", "Attachment", "ActsAsTaggableOn::Tag", "ActsAsTaggableOn::Tagging", "::ActsAsTaggableOn::Tag", "::ActsAsTaggableOn::Tagging", "CustomReport", "LibraryItem", "WorkSet", "Message"].include? class_name
      return true
    end
    false
  end
