    ...
    def collect_values_for_fields(fields)
      fields.collect do |field|
        ...
        if value.class == PictureUploader
          ...
          value.label
        elsif [Collection, ::Collection, User, Currency, Source, Style, Medium, Condition, Subset, Placeability, Cluster, FrameType, Owner, WorkStatus, BalanceCategory].include? value.class
          value.name
