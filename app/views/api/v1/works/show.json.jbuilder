...
json.sources(work.sources) { |attribute| json.extract! attribute, :name, :id } if current_api_user.ability.viewable_work_fields.include? if current_api_user.ability.viewable_work_fields.include?(:sources)
