...
class AppraisalsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @appraisal.save
        ...
        format.json { render json: @appraisal.errors, status: :unprocessable_content }
      end
    end
  end
  ...
  def appraisal_params
    params.require(:appraisal).permit(:appraised_on, :market_value, :replacement_value, :market_value_range, :replacement_value_range, :appraised_by, :reference, :notice, appraisee_attributes: [
