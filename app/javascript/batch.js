...
$(document).on('change', '#batch-work input[data-strategy-input-id], #batch-work textarea[data-strategy-input-id], #batch-work select[data-strategy-input-id]', (e) => {
...
$(document).on('change', '#work_cluster_id', (e) => {
  var name_target;
