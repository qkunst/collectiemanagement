  ...
  describe ".aggregations" do
    it "expected build result" do
      expected = {
        ...
        balance_category: {terms: {field: "balance_category.id", size: 999}},
        balance_category_missing: {missing: {field: "balance_category.id"}},
        ...
        object_format_code_missing: {missing: {field: "object_format_code"}},
        market_value: {terms: {field: "market_value", size: 999}},
        market_value_missing: {missing: {field: "market_value"}},
        ...
        replacement_value_missing: {missing: {field: "replacement_value"}},
