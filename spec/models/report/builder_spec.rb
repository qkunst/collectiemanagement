  ...
  describe "aggregation_builder" do
    it "should work while I'm refactoring" do
      expected = {
        ...
        :balance_category => {:terms=>{:field=>"balance_category_id", :size=>999}},
        ...
        :placeability => {terms: {field: "placeability.id", size: 999}}, :placeability_missing => {missing: {field: "placeability.id"}}, :themes => {terms: {field: "themes.id", size: 999}}, :themes_missing => {missing: {field: "themes.id"}}, :damage_types => {terms: {field: "damage_types.id", size: 999}}, :frame_damage_types => {terms: {field: "frame_damage_types.id", size: 999}},
        ...
        :market_value_missing => {:aggs=>{:market_value_range_missing=>{:aggs=>{:balance_category=>{:terms=>{:field=>"balance_category_id", :size=>999}}}, :missing=>{:field=>:market_value_max}}}, :missing=>{:field=>"market_value"}},
        :replacement_value => {terms: {field: "replacement_value", size: 999}},
        :replacement_value_missing => {:aggs=>{:replacement_value_range_missing=>{:aggs=>{:balance_category=>{:terms=>{:field=>"balance_category_id", :size=>999}}}, :missing=>{:field=>:market_value_max}}}, :missing=>{:field=>"replacement_value"}},
