  ...
  describe "aggregation_builder" do
    it "should work while I'm refactoring" do
      expected = {
        ...
        :market_value_missing => {:aggs=>{:balance_category=>{:terms=>{:field=>"balance_category_id", :size=>999}}, :market_value_range_missing=>{:missing=>{:field=>:market_value_max}}}, :missing=>{:field=>"market_value"}},
        :replacement_value => {terms: {field: "replacement_value", size: 999}},
        :replacement_value_missing => {:aggs=>{:balance_category=>{:terms=>{:field=>"balance_category_id", :size=>999}}, :replacement_value_range_missing=>{:missing=>{:field=>:market_value_max}}}, :missing=>{:field=>"replacement_value"}},
