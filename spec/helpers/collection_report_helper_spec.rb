...
<tr class="content span-6"><td colspan="6"><input type="checkbox" name="filter[location_raw][]" id="filter_location_raw_" value="Location A" /><a href="/collections/200799059/works?filter%5Blocation_raw%5D%5B%5D=Location+A">Location A</a></td><td class="count">1527</td></tr>
<tr class="section location_floor_raw span-5"><td class="spacer"></td><th colspan="6">Verdieping</th></tr>
<tr class="content span-4"><td class="spacer"></td><td class="spacer"></td><td colspan="4"><input type="checkbox" name="filter[location_floor_raw][]" id="filter_location_floor_raw_" value="Floor 2" /><a href="/collections/200799059/works?filter%5Blocation_floor_raw%5D%5B%5D=Floor+2&amp;filter%5Blocation_raw%5D%5B%5D=Location+A">Floor 2</a></td><td class="count">429</td></tr>
...
<tr class=\"content span-6\"><td colspan=\"6\"><input type=\"checkbox\" name=\"filter[condition_work_id][]\" id=\"filter_condition_work_id_\" value=\"1\" /><a href=\"/collections/#{@collection.id}/works?filter%5Bcondition_work_id%5D%5B%5D=1\">Goed (++)</a></td><td class=\"count\">2265</td></tr>
<tr class=\"content span-6\"><td colspan=\"6\"><input type=\"checkbox\" name=\"filter[condition_work_id][]\" id=\"filter_condition_work_id_\" value=\"4\" /><a href=\"/collections/#{@collection.id}/works?filter%5Bcondition_work_id%5D%5B%5D=4\">Slecht (--)</a></td><td class=\"count\">83</td></tr>
<tr class=\"content span-6\"><td colspan=\"6\"><input type=\"checkbox\" name=\"filter[condition_work_id][]\" id=\"filter_condition_work_id_\" value=\"3\" /><a href=\"/collections/#{@collection.id}/works?filter%5Bcondition_work_id%5D%5B%5D=3\">Matig (-)</a></td><td class=\"count\">38</td></tr>
<tr class=\"content span-6\"><td colspan=\"6\"><input type=\"checkbox\" name=\"filter[condition_work][]\" id=\"filter_condition_work_\" value=\"not_set\" /><a href=\"/collections/#{@collection.id}/works?filter%5Bcondition_work%5D%5B%5D=not_set\">Niets ingevuld</a></td><td class=\"count\">19</td></tr>
<tr class=\"content span-6\"><td colspan=\"6\"><input type=\"checkbox\" name=\"filter[condition_work_id][]\" id=\"filter_condition_work_id_\" value=\"2\" /><a href=\"/collections/#{@collection.id}/works?filter%5Bcondition_work_id%5D%5B%5D=2\">Redelijk/Voldoende (+)</a></td><td class=\"count\">2</td></tr>
<tr class=\"group_separator\"><td colspan=\"7\"></td></tr>
</table>")
    end
...
<tr class=\"content span-6\"><td colspan=\"6\"><input type=\"checkbox\" name=\"filter[object_creation_year][]\" id=\"filter_object_creation_year_\" value=\"2002\" /><a href=\"/collections/#{@collection.id}/works?filter%5Bobject_creation_year%5D%5B%5D=2002\">2002</a></td><td class=\"count\">109</td></tr>
<tr class=\"content span-6\"><td colspan=\"6\"><input type=\"checkbox\" name=\"filter[object_creation_year][]\" id=\"filter_object_creation_year_\" value=\"not_set\" /><a href=\"/collections/#{@collection.id}/works?filter%5Bobject_creation_year%5D%5B%5D=not_set\">Niets ingevuld</a></td><td class=\"count\">993</td></tr>
<tr class=\"group_separator\"><td colspan=\"7\"></td></tr>
</table>")
    end
